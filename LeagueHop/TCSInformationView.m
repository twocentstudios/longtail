...
- (instancetype)initWithViewModel:(TCSInformationViewModel *)viewModel {
    ...
    if (self != nil) {
        ...
        [self.subtitleLabel autoMatchDimension:ALDimensionWidth toDimension:ALDimensionWidth ofView:self withMultiplier:hWidthMultiplier];

        [self.titleLabel autoPinEdge:ALEdgeBottom toEdge:ALEdgeTop ofView:self.subtitleLabel withOffset:vLabelMargin];
        [self.titleLabel autoAlignAxisToSuperviewAxis:ALAxisVertical];
        [self.titleLabel autoMatchDimension:ALDimensionWidth toDimension:ALDimensionWidth ofView:self withMultiplier:hWidthMultiplier];
    }
    return self;
}
